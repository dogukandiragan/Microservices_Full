...
namespace EventBus.RabbitMQ
{
    public class EventBusRabbitMQ : BaseEventBus
    {
        ...
        private void SubsManager_OnEventRemoved(object sender, string eventName)
        {
            ...
            consumerChannel.QueueUnbind(queue: eventName, exchange: EventBusConfig.DefaultTopicName,
        ...
        private async void Consumer_Recieved(object sender, BasicDeliverEventArgs eventArgs)
        {
