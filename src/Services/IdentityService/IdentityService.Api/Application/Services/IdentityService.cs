    ...
    public class IdentityService : IIdentityService
    {
        public Task<LoginResponseModel> Login(LoginRequestModel requestModel)
        {
            ...
            var claims = new Claim[]
            {
                ...
                new Claim(ClaimTypes.Name, "Dogukan D"),
            };

            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("DgknSecretKeyShouldBeLong this is my custom Secret key for authentication"));
